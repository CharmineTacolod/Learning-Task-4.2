...
public class NormalWeightResult extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        Intent normalweight = new Intent(NormalWeightResult.this, MainActivity.class);
